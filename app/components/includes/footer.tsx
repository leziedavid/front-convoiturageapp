// app/components/includes/footer.tsx
...
const Footer: React.FC = () => {
    ...
    return (
        <footer>
            <div className="w-full bg-[#045b27] to-black mt-0">
                <div className="w-full px-4 md:px-12 lg:px-16 py-5 mx-auto">
                    <div className="grid gap-y-2 sm:gap-y-0 sm:flex sm:justify-between sm:items-center">
                        ...
                        <div>
                            <a className="size-10 inline-flex justify-center items-center gap-x-2 text-sm font-bold rounded-lg border border-transparent text-white hover:bg-primary transition-all duration-300" href="#">
