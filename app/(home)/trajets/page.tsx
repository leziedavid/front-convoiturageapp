...
//     arrival: z.string().min(1, { message: 'Le champ Arrivée est requis.' }),
//     date: z.string().nonempty({ message: 'La Date est requise.' }),
//     seats: z.number().min(1, { message: 'Le Nombre de places doit être au moins 1.' })
// });

// // Déclaration de la liste des bibliothèques à charger
...
//     const googleMaps = useGoogleMaps(process.env.NEXT_PUBLIC_GOOGLE_API_KEY!);
...
//     useEffect(() => {
//         // Assurez-vous que googleMaps est défini avant d'utiliser
//         if (googleMaps) {
//             // L'API Google Maps est chargée
//         }
//     }, [googleMaps]);

//     const handlePlaceChanged = (autocomplete: google.maps.places.Autocomplete, setter: React.Dispatch<React.SetStateAction<{ lat: number; lng: number } | null>>, placeSetter: React.Dispatch<React.SetStateAction<string>>) => {
//         const place = autocomplete.getPlace();
//         if (place && place.geometry && place.geometry.location) {
//             const { lat, lng } = place.geometry.location.toJSON();
//             setter({ lat, lng });
//             placeSetter(place.formatted_address || '');
//         } else {
//             console.error('Les informations géographiques ne sont pas disponibles pour ce lieu.');
//             setter(null);
//             placeSetter('');
//         }
//     };
...
//     const onSearchClick = () => {
//         const result = schema.safeParse({ departure, arrival, date, seats });

//         if (!result.success) {
//             // Afficher les erreurs de validation avec react-hot-toast
...
//             console.log('Départ:', departure, 'Coordonnées de départ:', startLatLng);
//             console.log('Arrivée:', arrival, 'Coordonnées d\'arrivée:', endLatLng);
//             console.log('Date:', date);
//             console.log('Nombre de places:', seats);
//         } else {
//             toast.error('Veuillez remplir les deux champs de ville.');
//         }
//     };
...
//                         <div>
//                             <Autocomplete
//                                 onLoad={(autocomplete) => handlePlaceChanged(autocomplete, setStartLatLng, setDeparture)}
//                             >
//                                 <input
//                                     type="text"
...
//                         <div>
//                             <Autocomplete
//                                 onLoad={(autocomplete) => handlePlaceChanged(autocomplete, setEndLatLng, setArrival)}
//                             >
//                                 <input
//                                     type="text"
//                                     className="block flex-1 border-none rounded-xl py-3 px-3 w-full hover:bg-gray-200 bg-gray-100 placeholder:text-gray-400 outline-none sm:text-sm sm:leading-6"
...
//                         <div>
//                             <button
//                                 className="p-2 text-white bg-[#f7872e] text-center h-full w-full py-3 rounded-b-xl md:rounded-bl-none md:rounded-r-xl flex justify-center items-center shadow-sm px-6 gap-2 text-base"
//                                 type="button"
