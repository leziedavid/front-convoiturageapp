...
const driverSchema = z.object({
    ...
    path: ["confirmerPassword"], // Indique où afficher l'erreur
});
    ...
    const onSubmit = async (data: DriverFormValues) => {
        ...
        try {
            ...
            if(apiResponse.code==201){
                ...
                toast.error(" Un compte existe dêja avec se email ou se non d'utilisateur")
            }
                ...
                <div className="px-6 lg:px-8">
                    <div className="mx-auto max-w-2xl py-20 sm:py-24">
                        <div className="text-center">
                            <h1 className="text-4xl font-bold tracking-tight text-white sm:text-4xl">Conducteur</h1>
                            <p className="mt-6 text-lg leading-8 text-gray-300">
                                Prenez le volant et faites des rencontres qui vous transportent
                            </p>
                        </div>
                    </div>
                </div>
                    ...
                    <div className="relative bg-white shadow-xl">
                        <div className="grid grid-cols-1 lg:grid-cols-3">
                            <div className="relative overflow-hidden bg-black py-10 px-6 sm:px-10 xl:p-12">
                                <h1 className="text-[30px] font-medium text-white">Gagnez jusqu’à 520,000 FCFA par mois*</h1>
                                <p className="mt-6 max-w-3xl text-base text-indigo-50"> Profitez au maximum de tous les avantages </p>
                            </div>

                            <div className="py-10 px-6 sm:px-10 lg:col-span-2 xl:p-12">
                                <h1 className="text-[25px] font-medium text-gray-900">Inscrivez-vous pour conduire ou livrer</h1>
                                <form onSubmit={handleSubmit(onSubmit)} className="mt-6 grid grid-cols-1 gap-y-6 sm:grid-cols-2 sm:gap-x-8">
                                    ...
                                    <div>
                                        ...
                                        <div className="mt-1">
                                            <input
                                                ...
                                                autoComplete="confirmerPassword"
                                                className="block w-full rounded-md border border-gray-300 py-3 px-4 text-gray-900 shadow-sm outline-none focus:border-orange-600 focus:ring-black"
                                            />
                                            ...
                                            <div className="text-center">
                                                <div className="mt-4 flex text-sm leading-6 text-gray-600">
                                                    <label htmlFor="file-upload"
                                                        className="relative cursor-pointer rounded-md bg-white font-semibold text-[#f7872e] focus-within:outline-none focus-within:ring-2 focus-within:ring-[#f7872e] focus-within:ring-offset-2 hover:text-indigo-500">
                                    ...
                                    <div className="sm:col-span-2 sm:flex sm:justify-end">
                                        <button
                                            type="submit"
                                            className="mt-2 inline-flex w-full items-center justify-center rounded-md border border-transparent outline-none bg-orange-500 px-6 py-2 text-base font-medium text-white shadow-sm hover:bg-black focus:outline-none focus:ring-2 focus:ring-black focus:ring-offset-2 sm:w-auto">
                                            Continuer
                                        </button>
                                    </div>
                                </form>
